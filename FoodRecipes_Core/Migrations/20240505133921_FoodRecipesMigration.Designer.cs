...
namespace FoodRecipes_Core.Migrations
{
    ...
    [Migration("20240505133921_FoodRecipesMigration")]
    partial class FoodRecipesMigration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FoodRecipes_Core.Models.Entites.Admin", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDateTime")
                        ...
                        .HasDefaultValue(new DateTime(2024, 5, 5, 16, 39, 20, 861, DateTimeKind.Local).AddTicks(8135));
            ...
            modelBuilder.Entity("FoodRecipes_Core.Models.Entites.Client", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 5, 16, 39, 20, 862, DateTimeKind.Local).AddTicks(2364));
            ...
            modelBuilder.Entity("FoodRecipes_Core.Models.Entites.Dish", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 5, 16, 39, 20, 862, DateTimeKind.Local).AddTicks(5751));
            ...
            modelBuilder.Entity("FoodRecipes_Core.Models.Entites.Donation", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 5, 16, 39, 20, 863, DateTimeKind.Local).AddTicks(42));
            ...
            modelBuilder.Entity("FoodRecipes_Core.Models.Entites.FoodSection", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 5, 16, 39, 20, 863, DateTimeKind.Local).AddTicks(2507));
            ...
            modelBuilder.Entity("FoodRecipes_Core.Models.Entites.Login", b =>
                {
            ...
            modelBuilder.Entity("FoodRecipes_Core.Models.Entites.Review", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 5, 5, 16, 39, 20, 866, DateTimeKind.Local).AddTicks(5857));
            ...
            modelBuilder.Entity("FoodRecipes_Core.Models.Entites.Login", b =>
                {
                    b.HasOne("FoodRecipes_Core.Models.Entites.Admin", "Admin")
                        .WithOne("Login")
                        .HasForeignKey("FoodRecipes_Core.Models.Entites.Login", "AdminId");

                    b.HasOne("FoodRecipes_Core.Models.Entites.Client", "Client")
                        .WithOne("Login")
                        .HasForeignKey("FoodRecipes_Core.Models.Entites.Login", "ClientId");
            ...
            modelBuilder.Entity("FoodRecipes_Core.Models.Entites.Review", b =>
                {
                    ...
                    b.HasOne("FoodRecipes_Core.Models.Entites.Login", "Login")
                        .WithMany()
